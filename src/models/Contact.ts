...
export class Contact {
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "supplierNumber",
            "baseName": "supplierNumber",
            "type": "number",
            "format": "int64"
        },
        {
            "name": "supplierAccountCode",
            "baseName": "supplierAccountCode",
            "type": "string",
            "format": ""
        },
        {
        ...
        {
            "name": "daysUntilInvoicingDueDate",
            "baseName": "daysUntilInvoicingDueDate",
            "type": "number",
            "format": "int32"
        },
        {
