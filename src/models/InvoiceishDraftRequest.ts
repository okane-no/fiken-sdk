...
export class InvoiceishDraftRequest {
    /**
    * Type of draft.
    */
    'type': InvoiceishDraftRequestTypeEnum;
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return InvoiceishDraftRequest.attributeTypeMap;
    }
...
export enum InvoiceishDraftRequestTypeEnum {
    Invoice = 'invoice',
