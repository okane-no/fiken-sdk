...
import { InboxResult } from '../model/inboxResult';
...
export class InboxApi {
     ...
     * @param file 
     */
    public async createInboxDocument (companySlug: string, name?: string, filename?: string, description?: string, file?: RequestFile, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/inbox'
        ...
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling createInboxDocument.');
        }
     ...
     */
    public async getInbox (companySlug: string, page?: number, pageSize?: number, sortBy?: 'createdDate asc' | 'createdDate desc' | 'name asc' | 'name desc', status?: 'all' | 'unused' | 'used', name?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<InboxResult>;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/inbox'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling getInbox.');
        }
        ...
        if (sortBy !== undefined) {
            localVarQueryParameters['sortBy'] = ObjectSerializer.serialize(sortBy, "'createdDate asc' | 'createdDate desc' | 'name asc' | 'name desc'");
        }

        if (status !== undefined) {
            localVarQueryParameters['status'] = ObjectSerializer.serialize(status, "'all' | 'unused' | 'used'");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Array<InboxResult>;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "Array<InboxResult>");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async getInboxDocument (companySlug: string, inboxDocumentId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InboxResult;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/inbox/{inboxDocumentId}'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling getInboxDocument.');
        }

        // verify required parameter 'inboxDocumentId' is not null or undefined
        if (inboxDocumentId === null || inboxDocumentId === undefined) {
            throw new Error('Required parameter inboxDocumentId was null or undefined when calling getInboxDocument.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: InboxResult;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "InboxResult");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
