...
import { DraftRequest } from '../model/draftRequest';
import { DraftResult } from '../model/draftResult';
import { Payment } from '../model/payment';
import { SaleRequest } from '../model/saleRequest';
import { SaleResult } from '../model/saleResult';
...
export class SalesApi {
    ...
    public setApiKey(key: SalesApiApiKeys, value: string) {
        (this.authentications as any)[SalesApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param file 
     */
    public async addAttachmentToSale (companySlug: string, saleId: number, filename?: string, attachToPayment?: boolean, attachToSale?: boolean, file?: RequestFile, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/sales/{saleId}/attachments'
        ...
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling addAttachmentToSale.');
        }

        // verify required parameter 'saleId' is not null or undefined
        if (saleId === null || saleId === undefined) {
            throw new Error('Required parameter saleId was null or undefined when calling addAttachmentToSale.');
        }
        ...
        if (attachToPayment !== undefined) {
            localVarFormParams['attachToPayment'] = ObjectSerializer.serialize(attachToPayment, "boolean");
        }

        if (attachToSale !== undefined) {
            localVarFormParams['attachToSale'] = ObjectSerializer.serialize(attachToSale, "boolean");
        }
     ...
     * @param file 
     */
    public async addAttachmentToSaleDraft (companySlug: string, draftId: number, filename?: string, file?: RequestFile, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/sales/drafts/{draftId}/attachments'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling addAttachmentToSaleDraft.');
        }

        // verify required parameter 'draftId' is not null or undefined
        if (draftId === null || draftId === undefined) {
            throw new Error('Required parameter draftId was null or undefined when calling addAttachmentToSaleDraft.');
        }
     ...
     * @param saleRequest 
     */
    public async createSale (companySlug: string, saleRequest: SaleRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/sales'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        let localVarFormParams: any = {};
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling createSale.');
        }

        // verify required parameter 'saleRequest' is not null or undefined
        if (saleRequest === null || saleRequest === undefined) {
            throw new Error('Required parameter saleRequest was null or undefined when calling createSale.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(saleRequest, "SaleRequest")
        };
     ...
     * @param draftRequest 
     */
    public async createSaleDraft (companySlug: string, draftRequest: DraftRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/sales/drafts'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        let localVarFormParams: any = {};
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling createSaleDraft.');
        }

        // verify required parameter 'draftRequest' is not null or undefined
        if (draftRequest === null || draftRequest === undefined) {
            throw new Error('Required parameter draftRequest was null or undefined when calling createSaleDraft.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(draftRequest, "DraftRequest")
        };
     ...
     * @param draftId The draftId (primary key of the returned object) is returned in the GET all drafts call. 
     */
    public async createSaleFromDraft (companySlug: string, draftId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/sales/drafts/{draftId}/createSale'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'draftId' + '}', encodeURIComponent(String(draftId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling createSaleFromDraft.');
        }

        // verify required parameter 'draftId' is not null or undefined
        if (draftId === null || draftId === undefined) {
            throw new Error('Required parameter draftId was null or undefined when calling createSaleFromDraft.');
        }
     ...
     * @param payment 
     */
    public async createSalePayment (companySlug: string, saleId: number, payment: Payment, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/sales/{saleId}/payments'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'saleId' + '}', encodeURIComponent(String(saleId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling createSalePayment.');
        }

        // verify required parameter 'saleId' is not null or undefined
        if (saleId === null || saleId === undefined) {
            throw new Error('Required parameter saleId was null or undefined when calling createSalePayment.');
        }

        // verify required parameter 'payment' is not null or undefined
        if (payment === null || payment === undefined) {
            throw new Error('Required parameter payment was null or undefined when calling createSalePayment.');
        }
     ...
     */
    public async deleteSale (companySlug: string, saleId: number, description: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SaleResult;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/sales/{saleId}/delete'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'saleId' + '}', encodeURIComponent(String(saleId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling deleteSale.');
        }

        // verify required parameter 'saleId' is not null or undefined
        if (saleId === null || saleId === undefined) {
            throw new Error('Required parameter saleId was null or undefined when calling deleteSale.');
        }

        // verify required parameter 'description' is not null or undefined
        if (description === null || description === undefined) {
            throw new Error('Required parameter description was null or undefined when calling deleteSale.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: SaleResult;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "SaleResult");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param draftId The draftId (primary key of the returned object) is returned in the GET all drafts call. 
     */
    public async deleteSaleDraft (companySlug: string, draftId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/sales/drafts/{draftId}'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'draftId' + '}', encodeURIComponent(String(draftId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling deleteSaleDraft.');
        }

        // verify required parameter 'draftId' is not null or undefined
        if (draftId === null || draftId === undefined) {
            throw new Error('Required parameter draftId was null or undefined when calling deleteSaleDraft.');
        }
     ...
     * @param saleId 
     */
    public async getSale (companySlug: string, saleId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SaleResult;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/sales/{saleId}'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'saleId' + '}', encodeURIComponent(String(saleId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling getSale.');
        }

        // verify required parameter 'saleId' is not null or undefined
        if (saleId === null || saleId === undefined) {
            throw new Error('Required parameter saleId was null or undefined when calling getSale.');
        }
     ...
     * @param saleId 
     */
    public async getSaleAttachments (companySlug: string, saleId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<Attachment>;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/sales/{saleId}/attachments'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'saleId' + '}', encodeURIComponent(String(saleId)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling getSaleAttachments.');
        }

        // verify required parameter 'saleId' is not null or undefined
        if (saleId === null || saleId === undefined) {
            throw new Error('Required parameter saleId was null or undefined when calling getSaleAttachments.');
        }
     ...
     * @param draftId The draftId (primary key of the returned object) is returned in the GET all drafts call. 
     */
    public async getSaleDraft (companySlug: string, draftId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DraftResult;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/sales/drafts/{draftId}'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'draftId' + '}', encodeURIComponent(String(draftId)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling getSaleDraft.');
        }

        // verify required parameter 'draftId' is not null or undefined
        if (draftId === null || draftId === undefined) {
            throw new Error('Required parameter draftId was null or undefined when calling getSaleDraft.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: DraftResult;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "DraftResult");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param draftId The draftId (primary key of the returned object) is returned in the GET all drafts call. 
     */
    public async getSaleDraftAttachments (companySlug: string, draftId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<Attachment>;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/sales/drafts/{draftId}/attachments'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'draftId' + '}', encodeURIComponent(String(draftId)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling getSaleDraftAttachments.');
        }

        // verify required parameter 'draftId' is not null or undefined
        if (draftId === null || draftId === undefined) {
            throw new Error('Required parameter draftId was null or undefined when calling getSaleDraftAttachments.');
        }
     ...
     */
    public async getSaleDrafts (companySlug: string, page?: number, pageSize?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<DraftResult>;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/sales/drafts'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling getSaleDrafts.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Array<DraftResult>;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "Array<DraftResult>");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param paymentId 
     */
    public async getSalePayment (companySlug: string, saleId: number, paymentId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Payment;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/sales/{saleId}/payments/{paymentId}'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'saleId' + '}', encodeURIComponent(String(saleId)))
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling getSalePayment.');
        }

        // verify required parameter 'saleId' is not null or undefined
        if (saleId === null || saleId === undefined) {
            throw new Error('Required parameter saleId was null or undefined when calling getSalePayment.');
        }

        // verify required parameter 'paymentId' is not null or undefined
        if (paymentId === null || paymentId === undefined) {
            throw new Error('Required parameter paymentId was null or undefined when calling getSalePayment.');
        }
     ...
     * @param saleId 
     */
    public async getSalePayments (companySlug: string, saleId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<Payment>;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/sales/{saleId}/payments'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'saleId' + '}', encodeURIComponent(String(saleId)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling getSalePayments.');
        }

        // verify required parameter 'saleId' is not null or undefined
        if (saleId === null || saleId === undefined) {
            throw new Error('Required parameter saleId was null or undefined when calling getSalePayments.');
        }
     ...
     */
    public async getSales (companySlug: string, page?: number, pageSize?: number, date?: string, dateLe?: string, dateLt?: string, dateGe?: string, dateGt?: string, lastModified?: string, lastModifiedLe?: string, lastModifiedLt?: string, lastModifiedGe?: string, lastModifiedGt?: string, saleNumber?: string, settled?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<SaleResult>;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/sales'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling getSales.');
        }
        ...
        if (dateLe !== undefined) {
            localVarQueryParameters['dateLe'] = ObjectSerializer.serialize(dateLe, "string");
        }

        if (dateLt !== undefined) {
            localVarQueryParameters['dateLt'] = ObjectSerializer.serialize(dateLt, "string");
        }

        if (dateGe !== undefined) {
            localVarQueryParameters['dateGe'] = ObjectSerializer.serialize(dateGe, "string");
        }

        if (dateGt !== undefined) {
            localVarQueryParameters['dateGt'] = ObjectSerializer.serialize(dateGt, "string");
        }

        if (lastModified !== undefined) {
            localVarQueryParameters['lastModified'] = ObjectSerializer.serialize(lastModified, "string");
        }

        if (lastModifiedLe !== undefined) {
            localVarQueryParameters['lastModifiedLe'] = ObjectSerializer.serialize(lastModifiedLe, "string");
        }

        if (lastModifiedLt !== undefined) {
            localVarQueryParameters['lastModifiedLt'] = ObjectSerializer.serialize(lastModifiedLt, "string");
        }

        if (lastModifiedGe !== undefined) {
            localVarQueryParameters['lastModifiedGe'] = ObjectSerializer.serialize(lastModifiedGe, "string");
        }

        if (lastModifiedGt !== undefined) {
            localVarQueryParameters['lastModifiedGt'] = ObjectSerializer.serialize(lastModifiedGt, "string");
        }

        if (saleNumber !== undefined) {
            localVarQueryParameters['saleNumber'] = ObjectSerializer.serialize(saleNumber, "string");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Array<SaleResult>;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "Array<SaleResult>");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async settledSale (companySlug: string, saleId: number, settledDate: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SaleResult;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/sales/{saleId}/settled'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'saleId' + '}', encodeURIComponent(String(saleId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling settledSale.');
        }

        // verify required parameter 'saleId' is not null or undefined
        if (saleId === null || saleId === undefined) {
            throw new Error('Required parameter saleId was null or undefined when calling settledSale.');
        }

        // verify required parameter 'settledDate' is not null or undefined
        if (settledDate === null || settledDate === undefined) {
            throw new Error('Required parameter settledDate was null or undefined when calling settledSale.');
        }

        if (settledDate !== undefined) {
            localVarQueryParameters['settledDate'] = ObjectSerializer.serialize(settledDate, "string");
        }
     ...
     * @param draftRequest 
     */
    public async updateSaleDraft (companySlug: string, draftId: number, draftRequest: DraftRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/sales/drafts/{draftId}'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'draftId' + '}', encodeURIComponent(String(draftId)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling updateSaleDraft.');
        }

        // verify required parameter 'draftId' is not null or undefined
        if (draftId === null || draftId === undefined) {
            throw new Error('Required parameter draftId was null or undefined when calling updateSaleDraft.');
        }

        // verify required parameter 'draftRequest' is not null or undefined
        if (draftRequest === null || draftRequest === undefined) {
            throw new Error('Required parameter draftRequest was null or undefined when calling updateSaleDraft.');
        }
