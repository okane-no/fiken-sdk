...
import { SendInvoiceRequest } from '../model/sendInvoiceRequest';
...
export class InvoicesApi {
     ...
     * @param file 
     */
    public async addAttachmentToInvoice (companySlug: string, invoiceId: number, filename?: string, file?: RequestFile, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/invoices/{invoiceId}/attachments'
        ...
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling addAttachmentToInvoice.');
        }

        // verify required parameter 'invoiceId' is not null or undefined
        if (invoiceId === null || invoiceId === undefined) {
            throw new Error('Required parameter invoiceId was null or undefined when calling addAttachmentToInvoice.');
        }
     ...
     * @param file 
     */
    public async addAttachmentToInvoiceDraft (companySlug: string, draftId: number, filename?: string, comment?: string, file?: RequestFile, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/invoices/drafts/{draftId}/attachments'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling addAttachmentToInvoiceDraft.');
        }

        // verify required parameter 'draftId' is not null or undefined
        if (draftId === null || draftId === undefined) {
            throw new Error('Required parameter draftId was null or undefined when calling addAttachmentToInvoiceDraft.');
        }
     ...
     */
    public async createInvoice (companySlug: string, invoiceRequest: InvoiceRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/invoices'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        let localVarFormParams: any = {};
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling createInvoice.');
        }

        // verify required parameter 'invoiceRequest' is not null or undefined
        if (invoiceRequest === null || invoiceRequest === undefined) {
            throw new Error('Required parameter invoiceRequest was null or undefined when calling createInvoice.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(invoiceRequest, "InvoiceRequest")
        };
     ...
     * @param counter 
     */
    public async createInvoiceCounter (companySlug: string, counter?: Counter, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/invoices/counter'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        let localVarFormParams: any = {};
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling createInvoiceCounter.');
        }
     ...
     */
    public async createInvoiceDraft (companySlug: string, invoiceishDraftRequest: InvoiceishDraftRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/invoices/drafts'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        let localVarFormParams: any = {};
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling createInvoiceDraft.');
        }
        ...
        if (invoiceishDraftRequest === null || invoiceishDraftRequest === undefined) {
            throw new Error('Required parameter invoiceishDraftRequest was null or undefined when calling createInvoiceDraft.');
        }
     ...
     * @param draftId The draftId (primary key of the returned object) is returned in the GET all drafts call. 
     */
    public async createInvoiceFromDraft (companySlug: string, draftId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/invoices/drafts/{draftId}/createInvoice'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'draftId' + '}', encodeURIComponent(String(draftId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling createInvoiceFromDraft.');
        }

        // verify required parameter 'draftId' is not null or undefined
        if (draftId === null || draftId === undefined) {
            throw new Error('Required parameter draftId was null or undefined when calling createInvoiceFromDraft.');
        }
     ...
     * @param draftId The draftId (primary key of the returned object) is returned in the GET all drafts call. 
     */
    public async deleteInvoiceDraft (companySlug: string, draftId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/invoices/drafts/{draftId}'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'draftId' + '}', encodeURIComponent(String(draftId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling deleteInvoiceDraft.');
        }

        // verify required parameter 'draftId' is not null or undefined
        if (draftId === null || draftId === undefined) {
            throw new Error('Required parameter draftId was null or undefined when calling deleteInvoiceDraft.');
        }
     ...
     * @param invoiceId The invoiceId (primary key of the returned object) is returned in the GET all invoices call; not to be confused with invoiceNumber 
     */
    public async getInvoice (companySlug: string, invoiceId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InvoiceResult;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/invoices/{invoiceId}'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'invoiceId' + '}', encodeURIComponent(String(invoiceId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling getInvoice.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: InvoiceResult;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "InvoiceResult");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param invoiceId The invoiceId (primary key of the returned object) is returned in the GET all invoices call; not to be confused with invoiceNumber 
     */
    public async getInvoiceAttachments (companySlug: string, invoiceId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<Attachment>;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/invoices/{invoiceId}/attachments'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'invoiceId' + '}', encodeURIComponent(String(invoiceId)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling getInvoiceAttachments.');
        }
     ...
     * @param companySlug Slug of company to retrieve
     */
    public async getInvoiceCounter (companySlug: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Counter;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/invoices/counter'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling getInvoiceCounter.');
        }
     ...
     * @param draftId The draftId (primary key of the returned object) is returned in the GET all drafts call. 
     */
    public async getInvoiceDraft (companySlug: string, draftId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InvoiceishDraftResult;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/invoices/drafts/{draftId}'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'draftId' + '}', encodeURIComponent(String(draftId)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling getInvoiceDraft.');
        }

        // verify required parameter 'draftId' is not null or undefined
        if (draftId === null || draftId === undefined) {
            throw new Error('Required parameter draftId was null or undefined when calling getInvoiceDraft.');
        }
     ...
     * @param draftId The draftId (primary key of the returned object) is returned in the GET all drafts call. 
     */
    public async getInvoiceDraftAttachments (companySlug: string, draftId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<Attachment>;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/invoices/drafts/{draftId}/attachments'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'draftId' + '}', encodeURIComponent(String(draftId)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling getInvoiceDraftAttachments.');
        }

        // verify required parameter 'draftId' is not null or undefined
        if (draftId === null || draftId === undefined) {
            throw new Error('Required parameter draftId was null or undefined when calling getInvoiceDraftAttachments.');
        }
     ...
     */
    public async getInvoiceDrafts (companySlug: string, page?: number, pageSize?: number, orderReference?: string, uuid?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<InvoiceishDraftResult>;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/invoices/drafts'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling getInvoiceDrafts.');
        }
        ...
        if (orderReference !== undefined) {
            localVarQueryParameters['orderReference'] = ObjectSerializer.serialize(orderReference, "string");
        }
    ...
    public async getInvoices (companySlug: string, page?: number, pageSize?: number, issueDate?: string, issueDateLe?: string, issueDateLt?: string, issueDateGe?: string, issueDateGt?: string, lastModified?: string, lastModifiedLe?: string, lastModifiedLt?: string, lastModifiedGe?: string, lastModifiedGt?: string, customerId?: number, settled?: boolean, orderReference?: string, invoiceDraftUuid?: string, invoiceNumber?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<InvoiceResult>;  }> {
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling getInvoices.');
        }
        ...
        if (invoiceDraftUuid !== undefined) {
            localVarQueryParameters['invoiceDraftUuid'] = ObjectSerializer.serialize(invoiceDraftUuid, "string");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Array<InvoiceResult>;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "Array<InvoiceResult>");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async sendInvoice (companySlug: string, sendInvoiceRequest: SendInvoiceRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/invoices/send'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        let localVarFormParams: any = {};
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling sendInvoice.');
        }
        ...
        if (sendInvoiceRequest === null || sendInvoiceRequest === undefined) {
            throw new Error('Required parameter sendInvoiceRequest was null or undefined when calling sendInvoice.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(sendInvoiceRequest, "SendInvoiceRequest")
        };
     ...
     */
    public async updateInvoice (companySlug: string, invoiceId: number, updateInvoiceRequest: UpdateInvoiceRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/invoices/{invoiceId}'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'invoiceId' + '}', encodeURIComponent(String(invoiceId)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling updateInvoice.');
        }
     ...
     * @param invoiceishDraftRequest 
     */
    public async updateInvoiceDraft (companySlug: string, draftId: number, invoiceishDraftRequest: InvoiceishDraftRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/invoices/drafts/{draftId}'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'draftId' + '}', encodeURIComponent(String(draftId)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling updateInvoiceDraft.');
        }

        // verify required parameter 'draftId' is not null or undefined
        if (draftId === null || draftId === undefined) {
            throw new Error('Required parameter draftId was null or undefined when calling updateInvoiceDraft.');
        }

        // verify required parameter 'invoiceishDraftRequest' is not null or undefined
        if (invoiceishDraftRequest === null || invoiceishDraftRequest === undefined) {
            throw new Error('Required parameter invoiceishDraftRequest was null or undefined when calling updateInvoiceDraft.');
        }
