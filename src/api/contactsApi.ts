...
export class ContactsApi {
     ...
     * @param file 
     */
    public async addAttachmentToContact (companySlug: string, contactId: number, filename?: string, comment?: string, file?: RequestFile, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/contacts/{contactId}/attachments'
        ...
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling addAttachmentToContact.');
        }

        // verify required parameter 'contactId' is not null or undefined
        if (contactId === null || contactId === undefined) {
            throw new Error('Required parameter contactId was null or undefined when calling addAttachmentToContact.');
        }
     ...
     * @param contactPerson 
     */
    public async addContactPersonToContact (companySlug: string, contactId: number, contactPerson: ContactPerson, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/contacts/{contactId}/contactPerson'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'contactId' + '}', encodeURIComponent(String(contactId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling addContactPersonToContact.');
        }

        // verify required parameter 'contactId' is not null or undefined
        if (contactId === null || contactId === undefined) {
            throw new Error('Required parameter contactId was null or undefined when calling addContactPersonToContact.');
        }

        // verify required parameter 'contactPerson' is not null or undefined
        if (contactPerson === null || contactPerson === undefined) {
            throw new Error('Required parameter contactPerson was null or undefined when calling addContactPersonToContact.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(contactPerson, "ContactPerson")
        };
     ...
     * @param contact 
     */
    public async createContact (companySlug: string, contact: Contact, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/contacts'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        let localVarFormParams: any = {};
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling createContact.');
        }
     ...
     */
    public async deleteContactContactPerson (companySlug: string, contactId: number, contactPersonId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/contacts/{contactId}/contactPerson/{contactPersonId}'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'contactId' + '}', encodeURIComponent(String(contactId)))
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling deleteContactContactPerson.');
        }

        // verify required parameter 'contactId' is not null or undefined
        if (contactId === null || contactId === undefined) {
            throw new Error('Required parameter contactId was null or undefined when calling deleteContactContactPerson.');
        }

        // verify required parameter 'contactPersonId' is not null or undefined
        if (contactPersonId === null || contactPersonId === undefined) {
            throw new Error('Required parameter contactPersonId was null or undefined when calling deleteContactContactPerson.');
        }
     ...
     * @param contactId 
     */
    public async getContact (companySlug: string, contactId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Contact;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/contacts/{contactId}'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'contactId' + '}', encodeURIComponent(String(contactId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling getContact.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Contact;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
     ...
     * @param contactId 
     */
    public async getContactContactPerson (companySlug: string, contactId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<ContactPerson>;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/contacts/{contactId}/contactPerson'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'contactId' + '}', encodeURIComponent(String(contactId)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling getContactContactPerson.');
        }

        // verify required parameter 'contactId' is not null or undefined
        if (contactId === null || contactId === undefined) {
            throw new Error('Required parameter contactId was null or undefined when calling getContactContactPerson.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Array<ContactPerson>;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "Array<ContactPerson>");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param contactPersonId 
     */
    public async getContactPerson (companySlug: string, contactId: number, contactPersonId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ContactPerson;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/contacts/{contactId}/contactPerson/{contactPersonId}'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'contactId' + '}', encodeURIComponent(String(contactId)))
            .replace('{' + 'contactPersonId' + '}', encodeURIComponent(String(contactPersonId)));
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling getContactPerson.');
        }

        // verify required parameter 'contactId' is not null or undefined
        if (contactId === null || contactId === undefined) {
            throw new Error('Required parameter contactId was null or undefined when calling getContactPerson.');
        }

        // verify required parameter 'contactPersonId' is not null or undefined
        if (contactPersonId === null || contactPersonId === undefined) {
            throw new Error('Required parameter contactPersonId was null or undefined when calling getContactPerson.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ContactPerson;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "ContactPerson");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
    ...
    public async getContacts (companySlug: string, page?: number, pageSize?: number, lastModified?: string, lastModifiedLe?: string, lastModifiedLt?: string, lastModifiedGe?: string, lastModifiedGt?: string, createdDate?: string, createdDateLe?: string, createdDateLt?: string, createdDateGe?: string, createdDateGt?: string, supplierNumber?: number, customerNumber?: number, memberNumber?: number, name?: string, organizationNumber?: string, email?: string, customer?: boolean, supplier?: boolean, inactive?: boolean, group?: string, sortBy?: 'lastModified asc' | 'lastModified desc' | 'createdDate asc' | 'createdDate desc', phoneNumber?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<Contact>;  }> {
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling getContacts.');
        }
        ...
        if (createdDate !== undefined) {
            localVarQueryParameters['createdDate'] = ObjectSerializer.serialize(createdDate, "string");
        }

        if (createdDateLe !== undefined) {
            localVarQueryParameters['createdDateLe'] = ObjectSerializer.serialize(createdDateLe, "string");
        }

        if (createdDateLt !== undefined) {
            localVarQueryParameters['createdDateLt'] = ObjectSerializer.serialize(createdDateLt, "string");
        }

        if (createdDateGe !== undefined) {
            localVarQueryParameters['createdDateGe'] = ObjectSerializer.serialize(createdDateGe, "string");
        }

        if (createdDateGt !== undefined) {
            localVarQueryParameters['createdDateGt'] = ObjectSerializer.serialize(createdDateGt, "string");
        }

        if (supplierNumber !== undefined) {
            localVarQueryParameters['supplierNumber'] = ObjectSerializer.serialize(supplierNumber, "number");
        }

        if (customerNumber !== undefined) {
            localVarQueryParameters['customerNumber'] = ObjectSerializer.serialize(customerNumber, "number");
        }

        if (memberNumber !== undefined) {
            localVarQueryParameters['memberNumber'] = ObjectSerializer.serialize(memberNumber, "number");
        }
        ...
        if (organizationNumber !== undefined) {
            localVarQueryParameters['organizationNumber'] = ObjectSerializer.serialize(organizationNumber, "string");
        }
        ...
        if (customer !== undefined) {
            localVarQueryParameters['customer'] = ObjectSerializer.serialize(customer, "boolean");
        }

        if (supplier !== undefined) {
            localVarQueryParameters['supplier'] = ObjectSerializer.serialize(supplier, "boolean");
        }

        if (inactive !== undefined) {
            localVarQueryParameters['inactive'] = ObjectSerializer.serialize(inactive, "boolean");
        }
        ...
        if (sortBy !== undefined) {
            localVarQueryParameters['sortBy'] = ObjectSerializer.serialize(sortBy, "'lastModified asc' | 'lastModified desc' | 'createdDate asc' | 'createdDate desc'");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Array<Contact>;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
     ...
     * @param contact 
     */
    public async updateContact (companySlug: string, contactId: number, contact: Contact, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/contacts/{contactId}'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'contactId' + '}', encodeURIComponent(String(contactId)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling updateContact.');
        }
     ...
     * @param contactPerson 
     */
    public async updateContactContactPerson (companySlug: string, contactId: number, contactPersonId: number, contactPerson: ContactPerson, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/companies/{companySlug}/contacts/{contactId}/contactPerson/{contactPersonId}'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
            .replace('{' + 'contactId' + '}', encodeURIComponent(String(contactId)))
            .replace('{' + 'contactPersonId' + '}', encodeURIComponent(String(contactPersonId)));
        ...
        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new Error('Required parameter companySlug was null or undefined when calling updateContactContactPerson.');
        }

        // verify required parameter 'contactId' is not null or undefined
        if (contactId === null || contactId === undefined) {
            throw new Error('Required parameter contactId was null or undefined when calling updateContactContactPerson.');
        }

        // verify required parameter 'contactPersonId' is not null or undefined
        if (contactPersonId === null || contactPersonId === undefined) {
            throw new Error('Required parameter contactPersonId was null or undefined when calling updateContactContactPerson.');
        }

        // verify required parameter 'contactPerson' is not null or undefined
        if (contactPerson === null || contactPerson === undefined) {
            throw new Error('Required parameter contactPerson was null or undefined when calling updateContactContactPerson.');
        }
