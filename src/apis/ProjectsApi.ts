...
export class ProjectsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createProject(companySlug: string, projectRequest: ProjectRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new RequiredError("ProjectsApi", "createProject", "companySlug");
        }


        // verify required parameter 'projectRequest' is not null or undefined
        if (projectRequest === null || projectRequest === undefined) {
            throw new RequiredError("ProjectsApi", "createProject", "projectRequest");
        }


        // Path Params
        const localVarPath = '/companies/{companySlug}/projects'
     ...
     * @param projectId 
     */
    public async deleteProject(companySlug: string, projectId: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new RequiredError("ProjectsApi", "deleteProject", "companySlug");
        }


        // verify required parameter 'projectId' is not null or undefined
        if (projectId === null || projectId === undefined) {
            throw new RequiredError("ProjectsApi", "deleteProject", "projectId");
        }


        // Path Params
        const localVarPath = '/companies/{companySlug}/projects/{projectId}'
            .replace('{' + 'companySlug' + '}', encodeURIComponent(String(companySlug)))
     ...
     * @param projectId 
     */
    public async getProject(companySlug: string, projectId: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new RequiredError("ProjectsApi", "getProject", "companySlug");
        }


        // verify required parameter 'projectId' is not null or undefined
        if (projectId === null || projectId === undefined) {
            throw new RequiredError("ProjectsApi", "getProject", "projectId");
        }
     ...
     */
    public async getProjects(companySlug: string, page?: number, pageSize?: number, completed?: boolean, name?: string, number?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new RequiredError("ProjectsApi", "getProjects", "companySlug");
        }
     ...
     */
    public async updateProject(companySlug: string, projectId: number, updateProjectRequest: UpdateProjectRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'companySlug' is not null or undefined
        if (companySlug === null || companySlug === undefined) {
            throw new RequiredError("ProjectsApi", "updateProject", "companySlug");
        }


        // verify required parameter 'projectId' is not null or undefined
        if (projectId === null || projectId === undefined) {
            throw new RequiredError("ProjectsApi", "updateProject", "projectId");
        }
        ...
        if (updateProjectRequest === null || updateProjectRequest === undefined) {
            throw new RequiredError("ProjectsApi", "updateProject", "updateProjectRequest");
        }
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(updateProjectRequest, "UpdateProjectRequest", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
...
export class ProjectsApiResponseProcessor {
     ...
     */
     public async createProjectWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getProjectWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ProjectResult >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ProjectResult = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "ProjectResult", ""
            ) as ProjectResult;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getProjectsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Array<ProjectResult> >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Array<ProjectResult> = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "Array<ProjectResult>", ""
            ) as Array<ProjectResult>;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
        }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateProjectWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("201", response.httpStatusCode)) {
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, undefined);
        }
