...
export class InvoiceishDraftResult {
    /**
    * Invoice draft ID
    */
    'draftId'?: number;
    ...
    */
    'type'?: InvoiceishDraftResult.TypeEnum = InvoiceishDraftResult.TypeEnum.Invoice;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "type",
            "baseName": "type",
            "type": "InvoiceishDraftResult.TypeEnum"
        },
        {
        ...
        {
            "name": "daysUntilDueDate",
            "baseName": "daysUntilDueDate",
            "type": "number"
        },
        {
            "name": "invoiceText",
            "baseName": "invoiceText",
            "type": "string"
        },
        {
            "name": "currency",
        ...
        {
            "name": "yourReference",
            "baseName": "yourReference",
            "type": "string"
        },
        {
            "name": "ourReference",
            "baseName": "ourReference",
            "type": "string"
        },
        {
            "name": "orderReference",
        ...
        },
        {
            "name": "lines",
            "baseName": "lines",
            "type": "Array<InvoiceishDraftLine>"
        },
        {
            "name": "net",
            "baseName": "net",
        ...
        {
            "name": "createdFromInvoiceId",
            "baseName": "createdFromInvoiceId",
            "type": "number"
        },
        {
            "name": "projectId",
    ...
    static getAttributeTypeMap() {
        return InvoiceishDraftResult.attributeTypeMap;
    }
}
...
export namespace InvoiceishDraftResult {
    export enum TypeEnum {
        Invoice = <any> 'invoice',
        CashInvoice = <any> 'cash_invoice',
        Offer = <any> 'offer',
        OrderConfirmation = <any> 'order_confirmation',
        CreditNote = <any> 'credit_note',
        RepeatingInvoice = <any> 'repeating_invoice'
    }
}
