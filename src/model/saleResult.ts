...
export class SaleResult {
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "totalPaidInCurrency",
            "baseName": "totalPaidInCurrency",
            "type": "number"
        },
        {
        ...
        {
            "name": "salePayments",
            "baseName": "salePayments",
            "type": "Array<Payment>"
        },
        {
            "name": "saleAttachments",
            "baseName": "saleAttachments",
    ...
    static getAttributeTypeMap() {
        return SaleResult.attributeTypeMap;
    }
}

export namespace SaleResult {
    export enum KindEnum {
        CashSale = <any> 'cash_sale',
        Invoice = <any> 'invoice',
        ExternalInvoice = <any> 'external_invoice'
    }
}
